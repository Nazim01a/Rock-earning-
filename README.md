...
#welcomeBox{display:none;position:fixed;top:10px;left:260px;animation:fadeInDown 1s;}
...
<!-- Login / Signup -->
<div id="authBox">
<h1 class="text-3xl font-bold mb-4">Welcome to <span style="color:#00bfff">Rock Earn</span></h1>
