...
#welcomeBox h2{color:#111;font-size:28px;font-weight:800;animation:glowText 2.5s infinite alternate;}
/* Content Section */
...
function openDashboard(){
  ...
  document.getElementById('welcomeBox').innerHTML=`<h2>Welcome to <span style="color:#111;font-weight:900;">Rock Earn</span> Premium</h2>`;
}
...
if(type==='plans'){content.innerHTML='<h2>Plans Section Coming Soon</h2>';} else {content.innerHTML='<h2>'+type+'</h2><p>Section content coming soon...</p>';}
}
