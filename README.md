...
<body class="bg-gray-50 min-h-screen flex flex-col items-center p-4"><header class="w-full max-w-6xl mb-6 p-6 rounded-xl bg-gradient-to-r from-indigo-600 via-pink-500 to-purple-600 text-white shadow-2xl text-center">
  <h1 class="text-4xl font-extrabold">Rock Earn SI LLC</h1>
...
</div><!-- Dashboard --><div id="dashboardStep" class="hidden flex flex-col gap-6">  <!-- Welcome & Balance -->  <div class="flex flex-col md:flex-row justify-between items-center gap-4">
    <div>
  ...
  </div>  <!-- Company Info -->  <div class="p-4 rounded-xl bg-gray-100 border shadow-sm text-gray-700">
    <h3 class="font-semibold mb-1">Company Info</h3>
    <p>Rock Earn SI LLC, established 2018, California. Professional simulated earning platform with interactive plans, deposits, withdrawals, referral bonus, and total profit tracking. Trusted and user-friendly experience.</p>
  </div>  <!-- Share Link & Invitation -->  <div class="p-4 rounded-xl bg-gray-50 border shadow-sm flex flex-col gap-2">
    <h3 class="font-semibold">Share & Invite</h3>
    <input type="text" id="shareLink" readonly class="p-2 border rounded-lg" value="">
    <p class="text-sm text-gray-500">Invite friends to earn bonus.</p>
  </div>  <!-- Plans -->  <div>
  ...
  </div>  <!-- Deposit / Withdraw & Customer Service -->  <div class="grid md:grid-cols-2 gap-4 mt-4">
  ...
  <h3 class="font-semibold mt-4">Customer Service</h3>
  <p class="text-sm text-gray-500">Contact: support@rockearn.com | WhatsApp: 0337-9827882</p>
</div>

  </div>  <!-- Plan Status & Activity -->  <div class="flex flex-col gap-4 mt-4">
    ...
    </div><div id="activityLog" class="p-4 rounded-xl bg-gray-50 border shadow-sm">
