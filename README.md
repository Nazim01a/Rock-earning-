...
@keyframes bgAnim{
    ...
    50%{background: linear-gradient(120deg,#222,#111);}
...
#banner{
    ...
    animation:bannerAnim 5s infinite alternate;
    z-index:999; font-size:32px; font-weight:bold; color:#fff; text-shadow:0 0 10px #00ffff;
}
@keyframes bannerAnim{
    0%{background: linear-gradient(90deg,#00bfff,#00ffff);}
    50%{background: linear-gradient(90deg,#00ffff,#00bfff);}
    100%{background: linear-gradient(90deg,#00bfff,#00ffff);}
}
</style>
</head>
<body>
...
// ---------------- All other functions (openSection, openDeposit, confirmDeposit, openWithdraw, confirmWithdraw, profile, copyText) remain same as previous code ----------------
